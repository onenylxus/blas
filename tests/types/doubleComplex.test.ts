...
describe('Double complex type', () => {
  ...
  it('should add value correctly', () => {
    ...
    isEqual(instance.get(), { r: value.r + 1, i: value.i - 1 });
  });
  ...
  it('should multiply value correctly', () => {
    ...
    isEqual(instance.get(), { r: value.r + value.i, i: value.i - value.r });
  });

  it('should divide value correctly', () => {
    instance.set(value);
    instance.div({ r: 1, i: -1 });
    isEqual(instance.get(), { r: (value.r - value.i) / 2, i: (value.i + value.r) / 2 });
  });
