...
describe('Double complex type', () => {
  ...
  it('should add value correctly', () => {
    instance.set(value);
    instance.add(_C(1, -1));
    isEqual(instance.get(), _C(value.r + 1, value.i - 1));
  });
  ...
  it('should multiply value correctly', () => {
    instance.set(value);
    instance.mul(_C(1, -1));
    isEqual(instance.get(), _C(value.r + value.i, value.i - value.r));
  });

  it('should divide value correctly', () => {
    instance.set(value);
    instance.div(_C(1, -1));
    isEqual(instance.get(), _C((value.r - value.i) / 2, (value.i + value.r) / 2));
  });
